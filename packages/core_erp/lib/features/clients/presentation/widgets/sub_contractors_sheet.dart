...
class SubContractorsSheet extends StatefulWidget {
  ...
  static Future<SubContractorDefinition?> show(BuildContext context, ClientDefinition client) {
...
class _SubContractorsSheetState extends State<SubContractorsSheet> {
  ...
  void _submit() async {
    ...
    try {
      await context.read<SubContractorsProvider>().create(widget.client.id, input);
      setState(() {
        _isAdding = false;
          ...
          if (_isAdding) ...[
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Add New Sub-contractor', style: TextStyle(fontWeight: FontWeight.bold)),
                              ...
                              trailing: IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (confirm == true && mounted) {
                                    context.read<SubContractorsProvider>().delete(sub.id);
                                  }
                                },
                              ),
                            ),
