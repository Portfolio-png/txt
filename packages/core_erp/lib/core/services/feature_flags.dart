...
class FeatureKeys {
  @FeatureFlag(
    ...
    desc: 'Enable the Orders module',
  )
  static const String modulesOrders = 'modules.orders';

  @FeatureFlag(
    category: 'Modules',
    displayName: 'Masters & Catalogs',
    desc: 'Enable the Masters & Catalogs module',
  )
  ...
  @FeatureFlag(
    ...
    desc: 'Enable the Inventory Management module',
  )
  ...
  @FeatureFlag(
    ...
    desc: 'Enable the Production & Runs module',
  )
  ...
  @FeatureFlag(
    ...
    desc: 'Enable the Preventative Maintenance module',
  )
  static const String modulesPm = 'modules.pm';

  @FeatureFlag(
    category: 'Modules',
    displayName: 'Freelancer Jobs Portal',
    desc: 'Enable the Freelancer Jobs Portal',
  )
  static const String modulesJobs = 'modules.jobs';

  @FeatureFlag(
    category: 'Modules',
    displayName: 'Delivery Challans',
    desc: 'Enable Delivery Challans',
  )
  ...
  @FeatureFlag(
    ...
    desc: 'Trash bin & broken-reference resolution center',
  )
  static const String modulesActionCenter = 'modules.actionCenter';

  @FeatureFlag(
    category: 'Orders Screen',
    displayName: 'Allow Dynamic Actions Dropdown',
    desc: 'Show dynamic actions on orders',
  )
  static const String ordersAllowCustomActions = 'orders.allowCustomActions';

  @FeatureFlag(
    category: 'Orders Screen',
    displayName: 'Allow Order Creation',
    desc: 'Allow creating new orders',
  )
  ...
  @FeatureFlag(
    ...
    desc:
        'Production report (quantities only, rates left blank) with print, on the order row menu',
  )
  static const String ordersShowReport = 'orders.showReport';

  @FeatureFlag(
    category: 'Machine Form',
    displayName: 'Disable Machine Custom Fields',
    desc: 'Hide custom fields on Machine Creation',
  )
  static const String featuresDisableMachineCustomFields =
      'features.disableMachineCustomFields';

  @FeatureFlag(
    category: 'Pipeline Builder',
    displayName: 'Multiple Scrap Items per Stage',
    desc:
        'Let a stage ship scrap to several items from the Scrap group instead of one',
  )
  static const String pipelineMultiScrapItems = 'production.multiScrapItems';

  @FeatureFlag(
    category: 'Pipeline Builder',
    displayName: 'Material Variation Paths',
    desc: 'Pick the exact item variation path for stage input/output materials',
  )
  static const String pipelineMaterialVariationPaths =
      'production.materialVariationPaths';
  ...
  @FeatureFlag(
    ...
    displayName: 'Catalog & Inventory Enhancements',
    desc:
        'Group-scoped item picker, combination groups, measurable units, inventory audit trail',
  )
  ...
  @FeatureFlag(
    category: 'Challans Screen',
    displayName: 'Single-type Challan View',
    desc:
        'Show one challan type full-width instead of the split Reception/Delivery view',
  )
